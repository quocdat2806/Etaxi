...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( PhoneNumberChanged value)?  phoneNumberChanged,TResult Function( SendOtpRequested value)?  sendOtpRequested,TResult Function( ShowOtpMethodSelection value)?  showOtpMethodSelection,TResult Function( HideOtpMethodSelection value)?  hideOtpMethodSelection,required TResult orElse(),}){
final _that = this;
switch (_that) {
case PhoneNumberChanged() when phoneNumberChanged != null:
return phoneNumberChanged(_that);case SendOtpRequested() when sendOtpRequested != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( PhoneNumberChanged value)  phoneNumberChanged,required TResult Function( SendOtpRequested value)  sendOtpRequested,required TResult Function( ShowOtpMethodSelection value)  showOtpMethodSelection,required TResult Function( HideOtpMethodSelection value)  hideOtpMethodSelection,}){
final _that = this;
switch (_that) {
case PhoneNumberChanged():
return phoneNumberChanged(_that);case SendOtpRequested():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( PhoneNumberChanged value)?  phoneNumberChanged,TResult? Function( SendOtpRequested value)?  sendOtpRequested,TResult? Function( ShowOtpMethodSelection value)?  showOtpMethodSelection,TResult? Function( HideOtpMethodSelection value)?  hideOtpMethodSelection,}){
final _that = this;
switch (_that) {
case PhoneNumberChanged() when phoneNumberChanged != null:
return phoneNumberChanged(_that);case SendOtpRequested() when sendOtpRequested != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String phoneNumber)?  phoneNumberChanged,TResult Function()?  sendOtpRequested,TResult Function()?  showOtpMethodSelection,TResult Function()?  hideOtpMethodSelection,required TResult orElse(),}) {final _that = this;
switch (_that) {
case PhoneNumberChanged() when phoneNumberChanged != null:
return phoneNumberChanged(_that.phoneNumber);case SendOtpRequested() when sendOtpRequested != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String phoneNumber)  phoneNumberChanged,required TResult Function()  sendOtpRequested,required TResult Function()  showOtpMethodSelection,required TResult Function()  hideOtpMethodSelection,}) {final _that = this;
switch (_that) {
case PhoneNumberChanged():
return phoneNumberChanged(_that.phoneNumber);case SendOtpRequested():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String phoneNumber)?  phoneNumberChanged,TResult? Function()?  sendOtpRequested,TResult? Function()?  showOtpMethodSelection,TResult? Function()?  hideOtpMethodSelection,}) {final _that = this;
switch (_that) {
case PhoneNumberChanged() when phoneNumberChanged != null:
return phoneNumberChanged(_that.phoneNumber);case SendOtpRequested() when sendOtpRequested != null:
return sendOtpRequested();case ShowOtpMethodSelection() when showOtpMethodSelection != null:
