...
import 'package:etaxi_driver/core/navigation/app_navigation.dart';
import 'package:etaxi_driver/core/navigation/router_path.dart';
import 'package:etaxi_driver/core/services/onboarding_service.dart';
import 'package:etaxi_driver/presentation/blocs/onboarding/onboarding_bloc.dart';
import 'package:etaxi_driver/presentation/blocs/onboarding/onboarding_event.dart';
import 'package:etaxi_driver/presentation/blocs/onboarding/onboarding_state.dart';
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            const SizedBox(width: AppDimensConstants.smallPadding),
            Expanded(
              child: RichText(
                softWrap: true,
                text: TextSpan(
